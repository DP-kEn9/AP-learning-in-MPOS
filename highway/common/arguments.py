...
def get_common_args():
    ...
    parser.add_argument('--map', type=str, default='highway-v0', help='Map to use')
    ...
    parser.add_argument('--her', type=int, default=None, help='Buffer type; whether to use HER. This value represents k')
            
    parser.add_argument('--gpu', type=int, default=None, help='GPU to use; disabled by default')
    parser.add_argument('--num', type=int, default=1, help='Number of program processes to run in parallel')
                                                                                          
            
    parser.add_argument('--target_update_period', type=int, default=200, help='Target network update period, in episodes')
                                                                                                
    parser.add_argument('--max_steps', type=int, default=2000000, help='Maximum number of time steps')
    parser.add_argument('--bs_rate', type=float, default=12.5, help='Start training when replay buffer size reaches this multiple of batch size')
    ...
    parser.add_argument('--epsilon_anneal_steps', type=int, default=50000, help='Number of steps over which epsilon decays to its minimum')
